  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication4App.team.home.createOrEditLabel" data-cy="TeamCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication4App.team.home.createOrEditLabel">Create or edit a Team</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="team-id"
                  label={translate('jhipsterRosterApplication4App.team.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.team.key')}
                id="team-key"
                name="key"
                data-cy="key"
                type="text"
