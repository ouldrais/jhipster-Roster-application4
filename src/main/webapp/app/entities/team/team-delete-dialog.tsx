...
export const TeamDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.team.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.team.delete.question" interpolate={{ id: teamEntity.id }}>
