...
export const TeamPlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.teamPlan.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.teamPlan.delete.question" interpolate={{ id: teamPlanEntity.id }}>
