    ...
    <Row>
      <Col md="8">
        <h2 data-cy="resourcePlanDetailsHeading">
          <Translate contentKey="jhipsterRosterApplication4App.resourcePlan.detail.title">ResourcePlan</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterRosterApplication4App.resourcePlan.shift">Shift</Translate>
          </dt>
