...
export const ResourcePlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.resourcePlan.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.resourcePlan.delete.question" interpolate={{ id: resourcePlanEntity.id }}>
