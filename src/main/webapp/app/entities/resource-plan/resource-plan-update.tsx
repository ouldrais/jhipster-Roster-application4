  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication4App.resourcePlan.home.createOrEditLabel" data-cy="ResourcePlanCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication4App.resourcePlan.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.resourcePlan.availability')}
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('jhipsterRosterApplication4App.resourcePlan.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('jhipsterRosterApplication4App.resourcePlan.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('jhipsterRosterApplication4App.resourcePlan.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
