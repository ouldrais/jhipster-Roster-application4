...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.department.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
