    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shiftDemandDetailsHeading">
          <Translate contentKey="jhipsterRosterApplication4App.shiftDemand.detail.title">ShiftDemand</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterRosterApplication4App.shiftDemand.shift">Shift</Translate>
          </dt>
