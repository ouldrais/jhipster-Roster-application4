  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication4App.shiftDemand.home.createOrEditLabel" data-cy="ShiftDemandCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication4App.shiftDemand.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.shiftDemand.count')}
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('jhipsterRosterApplication4App.shiftDemand.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterRosterApplication4App.shiftDemand.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
