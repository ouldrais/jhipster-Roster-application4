  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2
            id="jhipsterRosterApplication4App.positionRequirement.home.createOrEditLabel"
            data-cy="PositionRequirementCreateUpdateHeading"
          >
            <Translate contentKey="jhipsterRosterApplication4App.positionRequirement.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.positionRequirement.mandatoty')}
              ...
              <ValidatedField
                ...
                name="training"
                data-cy="training"
                label={translate('jhipsterRosterApplication4App.positionRequirement.training')}
                type="select"
              >
                <option value="" key="0" />
                {trainings
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('jhipsterRosterApplication4App.positionRequirement.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
