...
export const PositionRequirementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.positionRequirement.delete.question">
        <Translate
          contentKey="jhipsterRosterApplication4App.positionRequirement.delete.question"
