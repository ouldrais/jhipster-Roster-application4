  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication4App.resource.home.createOrEditLabel" data-cy="ResourceCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication4App.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="resource-id"
                  label={translate('jhipsterRosterApplication4App.resource.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.resource.key')}
                id="resource-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.resource.firstName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.resource.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.resource.teamRole')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication4App.resource.exchangeAllowed')}
              ...
              <ValidatedField
                ...
                name="team"
                data-cy="team"
                label={translate('jhipsterRosterApplication4App.resource.team')}
                type="select"
              >
                <option value="" key="0" />
                {teams
