...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.resource.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.resource.delete.question" interpolate={{ id: resourceEntity.id }}>
