...
export const PositionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.position.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.position.delete.question" interpolate={{ id: positionEntity.id }}>
