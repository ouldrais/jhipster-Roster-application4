...
export const ShiftDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication4App.shift.delete.question">
        <Translate contentKey="jhipsterRosterApplication4App.shift.delete.question" interpolate={{ id: shiftEntity.id }}>
